	...
	public void render(Context context, TweetDTO tweet, SafeHtmlBuilder sb) {
		...
		if (tweet != null) {
			...
			for(int i=0; i<Math.min(3, count); i++) {
				commentsContent.append("<div class='tweet_comment'>"
						+ "<div class='tweet_image'>"
							+ "<a href='#account/"+acct.getAccountId()+"'>"
								+ "<img src='"+tweet.getSender().getImageUrl()+"'>"
							+ "</a>"
						+ "</div>"
						+ "<div class='tweet_content'>"
							...
							+ "<div class='tweet_sender_link'>"
								+ "posted by <a href='#account/"+acct.getAccountId()+"'>"+tweet.getSender().getDisplayName()+"</a>"
