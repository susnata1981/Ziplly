...
import com.ziplly.app.client.view.account.AccountDetails;
...
public class ApplicationContext implements Serializable {
  ...
  private static StringDefinitions stringDefinitions = GWT.create(StringDefinitions.class);
  ...
  public void setAccountDetails(GetAccountDetailsResult result) {
    ...
    accountDetails.notifications.addAll(result.getAccountNotifications());
  }
...
//    public List<AccountNotificationDTO> notifications;
//  }
  ...
  public static StringDefinitions getStringDefinitions() {
