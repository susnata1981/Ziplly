...
public class TweetNotAvailableEvent extends GwtEvent<TweetNotAvailableEventHandler> {
	public static Type<TweetNotAvailableEventHandler> TYPE = new Type<TweetNotAvailableEventHandler>();
	
	@Override
	public com.google.gwt.event.shared.GwtEvent.Type<TweetNotAvailableEventHandler> getAssociatedType() {
		return TYPE;
	}
