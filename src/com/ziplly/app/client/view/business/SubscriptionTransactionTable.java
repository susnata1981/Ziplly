...
public class SubscriptionTransactionTable {
    ...
    public static GenericColumnDefinition<SubscriptionDTO, String> PLAN_NAME = new GenericColumnDefinition<SubscriptionDTO, String>(
        PLAN_NAME_HEADER, PLAN_NAME_COLUMN);
    public static GenericColumnDefinition<SubscriptionDTO, String> PLAN_DESCRIPTION = new GenericColumnDefinition<SubscriptionDTO, String>(
        PLAN_DESCRIPTION_HEADER, PLAN_DESCRIPTION_COLUMN);
    public static GenericColumnDefinition<SubscriptionDTO, String> STATUS = new GenericColumnDefinition<SubscriptionDTO, String>(
        STATUS_HEADER, STATUS_COLUMN);
    public static GenericColumnDefinition<SubscriptionDTO, String> RECURRING_AMOUNT = new GenericColumnDefinition<SubscriptionDTO, String>(
        RECURRING_AMOUNT_HEADER, RECURRING_AMOUNT_COLUMN);
    public static GenericColumnDefinition<SubscriptionDTO, String> TIME_CREATED = new GenericColumnDefinition<SubscriptionDTO, String>(
        TIME_CREATED_HEADER, TIME_CREATED_COLUMN);
    
    
    public static class Builder {
      private List<GenericColumnDefinition<SubscriptionDTO, String>> columns = new ArrayList<GenericColumnDefinition<SubscriptionDTO, String>>();
      
      public Builder with(GenericColumnDefinition<SubscriptionDTO, String> columnDef) {
      ...
      public CellTable<SubscriptionDTO> build() {
        ...
        for(GenericColumnDefinition<SubscriptionDTO, String> col : columns) {
