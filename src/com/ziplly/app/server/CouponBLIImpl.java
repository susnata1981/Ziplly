...
public class CouponBLIImpl implements CouponBLI {
	...
	@Override
	public String getQrcode(Long buyerAccountId, Coupon coupon)
			throws InternalError {
		try {
			return encode(buyerAccountId, coupon.getTweet().getSender()
					.getAccountId(), coupon.getCouponId(),
	...
	private String encode(Long buyerAccountId, Long sellerAccountId,
			Long couponId, Long quantityPurchased)
			throws UnsupportedEncodingException {
		String value = buyerAccountId + "" + sellerAccountId + "" + couponId
				+ "" + quantityPurchased;
