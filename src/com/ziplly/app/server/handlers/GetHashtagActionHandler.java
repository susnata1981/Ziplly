...
public class GetHashtagActionHandler extends
    AbstractAccountActionHandler<GetHashtagAction, GetHashtagResult> {
	...
	public GetHashtagResult
		...
		List<HashtagDTO> hashtags =
		    hashtagDao.findTopHashtagForNeighborhood(action.getNeighborhoodId(), n);
