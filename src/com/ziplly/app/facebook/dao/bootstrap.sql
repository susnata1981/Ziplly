...
insert into neighborhood (type,city,name,state, postalcode_id,parent_neighborhood_id) values ("regular", "seattle", "Magnolia","WA", 1, null);
insert into neighborhood (type,city,name,state, postalcode_id,parent_neighborhood_id) values ("regular", "seattle", "East Magnolia","WA", 1, 1);
insert into neighborhood (type,city,name,state, postalcode_id,parent_neighborhood_id) values ("regular", "seattle", "Baircliff","WA", 1, 1);
